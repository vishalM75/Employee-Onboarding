...
<asp:Content ContentPlaceHolderId="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <%--<script type="text/javascript" src="../Scripts/SharedLib/ckeditor.js"></script>--%>
  ...
  <%--<link rel="Stylesheet" type="text/css" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" />--%>
    ...
    <%--<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js"></script>--%>
    <script src="../Scripts/SharedLib/bootstrap.min.js"></script>
   ...
   <script type="text/javascript" src="../Scripts/JS/ConfigModal.js"></script>    
    ...
    <script type="text/babel" src="../Scripts/ReactComponents/EmailTemplateModal.js"></script>
    <script type="text/babel" src="../Scripts/ReactComponents/EmailTemplateTile.js"></script>    
    ...
    <script type="text/babel" src="../Scripts/ReactComponents/EmailTemplateMain.js"></script>
