...
<asp:Content ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/babel-polyfill/7.6.0/polyfill.js"></script>
    <%--<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/babel-polyfill/7.6.0/polyfill.min.js"></script>--%>
    ...
    <%--    <script type="text/javascript" src="../Scripts/SharedLib/react.development.js" crossorigin></script>
    <script type="text/javascript" src="../Scripts/SharedLib/react-dom.development.js" crossorigin></script>--%>
    ...
    <%--<script type="text/javascript" src="../Scripts/SharedLib/table2excel.js"></script>--%>
    ...
    <script type="text/javascript" src="../Scripts/jspdf/jspdf.js"></script>
     <script type="text/javascript" src="../Scripts/SharedLib/jquery.base64.js"></script>
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.0.272/jspdf.debug.js"></script>
    <script type="text/javascript" src="../Scripts/SharedLib/tableExport.js"></script>
    ...
    <script type="text/babel" src="../Scripts/ReactComponents/EOBReport.js"></script>
