...
<%--    <script type="text/javascript" src="../Scripts/SharedLib/react.development.js" crossorigin></script>
    ...
    <script type="text/babel" src="../Scripts/ReactComponents/StandardTaskModalDialog.js"></script>
    <script type="text/babel" src="../Scripts/ReactComponents/DeleteModalDialog.js"></script>

    

    <script type="text/babel" src="../Scripts/ReactComponents/StandardTaskMain.js"></script>
